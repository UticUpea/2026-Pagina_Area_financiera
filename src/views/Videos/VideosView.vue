  ...
  <div>
    ...
    <div class="course-area pd-top-120 pd-bottom-120">
      <div class="container">
          ...
          <div class="col-lg-8 col-md-10">
            <div class="search-wrapper">
              <div class="search-input-group">
                ...
                <input
                  type="text"
                  placeholder="Buscar videos por título, descripción o tipo..."
                  v-model="searchQuery"
                  @input="onSearchInput"
              ...
              <div v-if="isSearching" class="search-info">
                <span>{{ filteredVideos.length }} resultado(s) encontrado(s)</span>
        ...
        <div v-if="isSearching && filteredVideos.length === 0" class="row justify-content-center">
          <div class="col-12 text-center py-5">
            <i class="fa fa-video-slash text-muted" style="font-size: 4rem; opacity: 0.3;"></i>
            <h3 class="mt-4">No se encontraron videos</h3>
            <p class="text-muted">
        ...
        <div v-else class="row justify-content-center">
          ...
          <div v-if="!isSearching && videos.length === 0" class="col-12 text-center py-5">
            <i class="fa fa-video-slash text-muted" style="font-size: 4rem; opacity: 0.3;"></i>
            <h2 class="mt-4">Sin videos disponibles</h2>
          ...
          <template v-else>
            ...
            >
              <div class="single-course-inner">
                <div class="thumb">
                  <iframe
                    :src="getVideoUrl(vid.video_enlace)"
                    frameborder="0"
                    allowfullscreen
                    loading="lazy"
                    ...
                    <div class="row align-items-center">
                      <div class="col-8">
                        <span class="video-type">
                          <i class="fa fa-tag"></i> {{ vid.video_tipo || 'Video' }}
                        </span>
                      </div>
                      <div class="col-4 text-right">
                        <router-link
                          ...
                          class="btn-leer-mas"
                        >
                          Ver <i class="fa fa-play-circle"></i>
                        </router-link>
                      </div>
                    </div>
                  </div>
          ...
          <nav v-if="totalPages > 1 && !isSearching" class="col-12 text-center mt-4">
  ...
  methods: {
    ...
    changePage(page) {
      if (page >= 1 && page <= this.totalPages && page !== this.currentPage) {
        ...
        this.$nextTick(() => {
          const videosSection = document.querySelector('.course-area');
          if (videosSection) {
